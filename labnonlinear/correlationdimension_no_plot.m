function [rcM,cM,rdM,dM,nuM] = correlationdimension_no_plot(xV,tau,mmax,tittxt,fac,logrmin,logrmax);
...
eval(['!/home/mikalaki/bin/tisean/d2 tmp.dat -t50 -d',int2str(tau),' -M1,',int2str(mmax),' -N0 -o tmp'])
